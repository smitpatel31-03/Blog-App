...
function App() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <img src="/svg/pencil2.svg" className="absolute top-5 left-75 w-25 sm:w-70 sm:top-10 sm:left-310" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        {/* First input box */}
        <div className="mt-6 w-70 sm:max-w-md">
      ...
      <img src="/svg/comaps.svg" className="absolute bottom-40 z-1 left-40 w-25 sm:w-50 sm:left-210" />
