...
function App() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <img src="/svg/pencil2.svg" className="absolute z-1 top-20 left-75 w-25 sm:w-70 sm:top-10 sm:left-310" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        {/* First input box */}
        <div className="mt-6 w-50 sm:max-w-md sm:w-full">
      ...
      <img src="/svg/comaps.svg" className="absolute bottom-70 z-1 left-55 w-25 sm:w-60 sm:left-220 sm:bottom-70" />
